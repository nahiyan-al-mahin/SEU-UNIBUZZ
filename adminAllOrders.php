...
// get all orders with buyer name and payment info
          ...
          <div class="tab-all-users" style="overflow-x:auto;">
            <table class="users-table">
              ...
              <tbody>
                ...
                <tr>
                  <td><span style="font-size:.76rem;color:var(--text-3)"><?php echo $order['Order_Id']; ?></span></td>
                  <td><span style="font-size:.76rem;color:var(--text-3)"><?php echo $order['First_Name'] . " " . $order['Last_Name']; ?></span></td>
                  <td><span style="font-size:.76rem;color:var(--text-3)"><?php echo $order['Email']; ?></span></td>
                  <td><span style="font-size:.76rem;color:var(--text-3)">৳<?php echo number_format($order['Total_amount'], 2); ?></span></td>
                  <td><span style="font-size:.76rem;color:var(--text-3)"><?php echo $order['Order_Date']; ?></span></td>
                  <td><span class="mono-text"><?php echo $order['Status']; ?></span></td>
                  <td><span class="mono-text" style="font-size:.7rem"><?php echo $order['Payment_Method'] ?? '—'; ?></span></td>
                  <td><span style="font-size:.76rem;color:var(--text-3)"><?php echo $order['Payment_Status'] ?? '—'; ?></span></td>
                </tr>
                <?php endforeach; ?>
