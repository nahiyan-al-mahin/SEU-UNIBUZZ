  ...
  <div class="right-side">
    ...
    <div class="page-content-scroll">
      ...
      <div class="divider-row">
        <div class="divider-label">All Sellers Info</div>
                ...
                <tr>
                  <td>
                    <div class="user-info-cell">
                      <div class="user-initial-circle" style="background:#3498DB;"><?php echo strtoupper(substr($seller['First_Name'], 0, 1)); ?></div>
                      <div>
                        <div class="user-fullname"><?php echo $seller['First_Name'] . " " . $seller['Last_Name']; ?></div>
                      </div>
                    </div>
                  </td>
                  <td><span style="font-size:.76rem;color:var(--text-3)"><?php echo $seller['Email']; ?></span></td>
                  <td><span class="mono-text"><?php echo $seller['Mobile']; ?></span></td>
                  <td><span class="mono-text" style="font-size:.7rem"><?php echo $seller['Department']; ?></span></td>
                  <td><span class="mono-text" style="font-size:.7rem"><?php echo $seller['Semester']; ?></span></td>
                  <td><span class="mono-text" style="font-size:.7rem"><?php echo $seller['Student_Id']; ?></span></td>
                  <td><span class="mono-text" style="font-size:.7rem"><?php echo $seller['Rating']; ?></span></td>
                  <td><span class="mono-text" style="font-size:.7rem"><?php echo $seller['total_products']; ?></span></td>
                  <td>
                    <form method="POST">
                        <input type="hidden" name="delete_seller_id" value="<?php echo $seller['User_Id']; ?>">
                        <button type="submit" name="delete_seller" class="btn-deleteuser">Delete</button>
                    </form>
                  </td>
                </tr>
                <?php endforeach; ?>
